...
using System;
using Infostructure.SimpleList.DataAccess;

namespace Infostructure.SimpleList.DataAccess.Tests
{
    ...
    public class UserRepositoryTest
    {
        ...
        public void GetUserByUserNameAndPasswordTest()
        {
            ...
            User actual;
            actual = target.GetUserByUserNameAndPassword(userName, password);
